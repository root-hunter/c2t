...
[[nodiscard]] int telegram_send_encrypted_data(const void *encrypted_data, size_t length,
                                               ...
                                               const c2t_clipboard_source_t *source);
[[nodiscard]] int telegram_send_file(const void *data, size_t length, const char *mime_type,
                                    const char *filename,
                                    const c2t_clipboard_source_t *source);
[[nodiscard]] int telegram_send_encrypted_file(const void *encrypted_data, size_t length,
                                               const unsigned char nonce[C2T_CRYPTO_NONCE_SIZE],
                                               const char *mime_type,
                                               const char *filename,
                                               const c2t_clipboard_source_t *source);
