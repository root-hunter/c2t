...
# ----------------------------------------------------------------------------
# Generate 100% Polymorphic, Windows SxS-Compliant Manifest (.rsrc/MANIFEST/1)
# Ensures perfect double-click launching on all Windows versions while guaranteeing
# unique SHA256 resource signatures per build
# ----------------------------------------------------------------------------
...
string(RANDOM LENGTH 64 ALPHABET "0123456789abcdef" MANIFEST_NONCE_1)
string(RANDOM LENGTH 64 ALPHABET "0123456789abcdef" MANIFEST_NONCE_2)
...
<assembly xmlns=\"urn:schemas-microsoft-com:asm.v1\" manifestVersion=\"1.0\">
  ...
  <!-- Build-Nonce: ${MANIFEST_NONCE_1}${MANIFEST_NONCE_2} -->
</assembly>
")
